-- ============================================================
-- JNE Tables Unification SQL Script (Updated v2)
-- ============================================================
-- Combines all relevant tables with CMS_CNOTE as the main table
-- Uses CTEs with ROW_NUMBER() to dedupe and prevent row explosion
-- Maintains 1 row = 1 shipment
--
-- Tables included (34 total):
-- Core: CMS_CNOTE, CMS_CNOTE_POD, CMS_APICUST
-- Runsheet: CMS_DRCNOTE, CMS_MRCNOTE, CMS_DRSHEET, CMS_MRSHEET, CMS_DRSHEET_PRA
-- Inbound HO: CMS_DHICNOTE, CMS_MHICNOTE
-- Outbound HO: CMS_DHOCNOTE, CMS_MHOCNOTE
-- Undelivered: CMS_DHOUNDEL_POD, CMS_MHOUNDEL_POD
-- Hub Ops: CMS_DHI_HOC, CMS_MHI_HOC
-- Manifest: CMS_MFCNOTE, CMS_MANIFEST
-- Bags: CMS_DBAG_HO, CMS_DMBAG, CMS_DHOV_RSHEET
-- SJ Chain: CMS_DSJ, CMS_MSJ, CMS_RDSJ
-- SMU: CMS_DSMU, CMS_MSMU
-- Status/Cost: CMS_DSTATUS, CMS_COST_DTRANSIT_AGEN, CMS_COST_MTRANSIT_AGEN
-- Reference: CMS_DROURATE, ORA_ZONE, T_MDT_CITY_ORIGIN, LASTMILE_COURIER
-- Crossdock: T_CROSSDOCK_AWD, T_GOTO
-- ============================================================
...
-- ============================================================
-- MAIN SELECT WITH ALL LEFT JOINS
-- ============================================================
SELECT 
    -- ========================================
    -- CMS_CNOTE (all columns)
    -- ========================================
    cn.*,
    ...
    -- ========================================
    -- 4. CMS_APICUST (selected columns)
    -- ========================================
...
-- 10. CMS_MHICNOTE (via DHICNOTE_NO)
...
-- 12. CMS_MHOCNOTE (via DHOCNOTE_NO)
...
-- 14. CMS_MHOUNDEL_POD (via DHOUNDEL_NO)
